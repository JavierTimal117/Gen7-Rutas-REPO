...
<body>
    ...
    var a = 1;
        ...
        function getDireccion(fuente){
            ...
            {
                alert("No podemos obtener datos sino proporciona una dirección");
                $('#myModal').modal('hide');
            }
        }
        ...
        /*function getDireccion(fuente){
            // consumir el api de ...........
            var geocoder = new google.maps.Geocoder();
            geocoder.geocode({"address": "boulevard san felipe 224"}, function(p1,p2){
                console.log("hola");
                console.log(p1);
                console.log(p2);
                console.log(p1[0].address_components[1].long_name)
                //document.getElementById("Calle").value = p1[0].address_components[1].long_name;
                $("#Calle").val(p1[0].address_components[1].long_name);
                $("#Numero").val(p1[0].address_components[0].long_name);
                $("#Colonia").val(p1[0].address_components[2].long_name);
                $("#Ciudad").val(p1[0].address_components[3].long_name);
                $("#Estado").val(p1[0].address_components[4].long_name);
                $("#CP").val(p1[0].address_components[6].long_name);
